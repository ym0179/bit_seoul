...
layer1_1 = LSTM(128, activation='relu')(input3)
layer1_2 = Dense(128, activation='relu')(layer1_1)
layer1_3 = Dropout(0.3)(layer1_2)
output3 = Dense(128, activation='relu')(layer1_3)

#모델 4.
input4 = Input(shape=(5,3)) #입력 4
layer2_1 = Conv1D(64, (2), padding="same")(input4)
layer2_2 = MaxPooling1D(pool_size=2)(layer2_1)
layer2_3 = Dropout(0.3)(layer2_2)
layer2_4 = Conv1D(32, (2), padding="same")(layer2_3)
layer2_5 = MaxPooling1D(pool_size=2)(layer2_4)
layer2_6 = Dropout(0.3)(layer2_5)
layer2_7 = Conv1D(16, (2), padding="same")(layer2_6)
layer2_8 = Dropout(0.3)(layer2_7)
layer2_9 = Flatten()(layer2_8)
layer2_10 = Dense(64, activation='relu')(layer2_9)
output4 = Dense(32, activation='relu')(layer2_10)
