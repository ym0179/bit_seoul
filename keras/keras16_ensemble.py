...
x1_train, x1_test, y1_train, y1_test = train_test_split(x1,y1,train_size=0.7,shuffle=True)
...
output1 = Dense(3,name='output1_3')(output1) #출력 1
...
print("result : ",result)
#5개의 값
#1.전체 loss, 2.첫번째output의 loss, 3.두번째output의 loss, 4.첫번째output의 mse, 5.두번째output의 mse
