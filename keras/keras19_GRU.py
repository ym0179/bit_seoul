...
model.add(GRU(30, input_shape = (3,1))) => 3*(30(30+1)+30)
model.add(GRU(10, input_shape = (3,1))) => 3*(10(10+1)+10)


============================================================
계산방법2.

model.add(GRU(30, input_shape = (3,1))) => 3*(1+1+10)*10
...
# #4. 평가, 예측
# x_input = np.array([5,6,7]) # GRU input 3차원
# # (3, ) -> (1,3,1)
