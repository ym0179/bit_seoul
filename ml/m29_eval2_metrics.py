...
# 평가지표
# multi-class classification merror, mlogloss
...
print("eval's results [mlogloss]: ", results['validation_1']['mlogloss'][-1]) #마지막 metrics 값
print("eval's results [merror]: ", results['validation_1']['merror'][-1]) #마지막 metrics 값
