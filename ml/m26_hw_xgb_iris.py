...
'''
RobustScaler
최적 하이퍼 파라미터 :  {'xgb__n_estimators': 9, 'xgb__max_depth': 5, 'xgb__learning_rate': 0.1, 'xgb__colsample_bytree': 0.6, 'xgb__colsample_bylevel': 0.9}
최고 정확도 : 0.9667
acc :  0.9

StandardScaler
최적 하이퍼 파라미터 :  {'xgb__n_estimators': 9, 'xgb__max_depth': 6, 'xgb__learning_rate': 0.1, 'xgb__colsample_bytree': 0.6, 'xgb__colsample_bylevel': 0.9}
최고 정확도 : 0.9667
acc :  0.9

MinMaxScaler
최적 하이퍼 파라미터 :  {'xgb__n_estimators': 9, 'xgb__max_depth': 6, 'xgb__learning_rate': 0.5, 'xgb__colsample_bytree': 0.9, 'xgb__colsample_bylevel': 0.7}
최고 정확도 : 0.9583
acc :  0.9333333333333333

MaxAbsScaler
최적 하이퍼 파라미터 :  {'xgb__n_estimators': 9, 'xgb__max_depth': 6, 'xgb__learning_rate': 0.1, 'xgb__colsample_bytree': 0.6, 'xgb__colsample_bylevel': 0.7}
최고 정확도 : 0.9667
acc :  0.9
'''