...
params = [
    {'rf__n_estimators' : [200, 300], #결정 트리의 개수, default=10, 많을 수록 좋은 성능이 나올 "수"도 있음 (시간이 오래걸림)
...
'''
r2_score :  0.9193022757450232
최적의 매개변수 :  Pipeline(steps=[('scaler', RobustScaler()),      
                ('rf',
                 RandomForestRegressor(max_depth=8, min_samples_leaf=3,
                                       min_samples_split=10, n_jobs=-1))])
최적의 매개변수 :  {'rf__n_jobs': -1, 'rf__n_estimators': 100, 'rf__min_samples_split': 10, 'rf__min_samples_leaf': 3, 'rf__max_depth': 
8}
