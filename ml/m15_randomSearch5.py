...
model = RandomizedSearchCV(RandomForestClassifier(), params, cv=kfold, verbose=2)
...
최적의 매개변수 :  RandomForestClassifier(max_depth=10, min_samples_leaf=3, min_samples_split=5,
                       n_jobs=-1)
최적 하이퍼 파라미터 :  {'n_jobs': -1, 'n_estimators': 100, 'min_samples_split': 5, 'min_samples_leaf': 3, 'max_depth': 10}
최고 정확도 : 0.9788
(테스트 데이터 세트 정확도) 최종정답률 :  1.0
'''