...
model = GridSearchCV(RandomForestClassifier(), params, cv=kfold, verbose=2)
...
최적의 매개변수 :  RandomForestClassifier(max_depth=8, min_samples_leaf=3, min_samples_split=5,
                       n_jobs=-1)
최적 하이퍼 파라미터 :  {'max_depth': 8, 'min_samples_leaf': 3, 'min_samples_split': 5, 'n_estimators': 100, 'n_jobs': -1}
최고 정확도 : 0.9857
