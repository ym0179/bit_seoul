...
#input node 개수 -> 단어 사전의 개수로 통일 (단어사전 개수보다 크게 넣어주는건 상관없는데 (여분 메모리를 가지고 있는거여서 상관 X) 적게 넣으면 안됨.터짐)
#output node 개수 -> 바꿀 수 있음 (벡터로 줄인거)
#input_length -> 문장길이 (5)
# model.add(LSTM(32))
model.add(Conv1D(32, 2)) # 2=커널사이즈
...
=================================================================
embedding (Embedding)        (None, 5, 10)             250              # 단어 사전 작성
_________________________________________________________________
